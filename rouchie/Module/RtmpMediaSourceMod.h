...
class RtmpMediaSourceMod : public RQModuleHelper<RtmpMediaSourceMod>, public mediakit::MediaSink {
public:
    RtmpMediaSourceMod(const std::string& mp4File, const std::string& app, const std::string& stream);
...
private:
    ...
    RtmpMediaSourceMuxer::Ptr _muxer;
